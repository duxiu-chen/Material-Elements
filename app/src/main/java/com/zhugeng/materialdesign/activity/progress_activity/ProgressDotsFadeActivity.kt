...
import kotlinx.android.synthetic.main.activity_progress_dots_fade.*
import java.util.*

class ProgressDotsFadeActivity: AppCompatActivity() {
    ...
    fun startAnim(){
        ...
        handler.postDelayed(Runnable {
            ...
            anim.addUpdateListener {
                ...
                if (x == 0f){
                    recyclerView.layoutAnimation = AnimationUtils.loadLayoutAnimation(this@ProgressDotsFadeActivity, R.anim.layout_anim_fade_in_list_item)
                    recyclerView.layoutManager = LinearLayoutManager(this@ProgressDotsFadeActivity)
                    initData()
