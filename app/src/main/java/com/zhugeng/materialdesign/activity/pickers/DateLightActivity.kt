...
class DateLightActivity: AppCompatActivity() {
    ...
    private fun initView() {
        ...
        btn_get_date.setOnClickListener {
            DatePickerDialog(this,R.style.LightDatePickerDialogTheme, DatePickerDialog.OnDateSetListener { view, year, month, dayOfMonth ->
                mYear = year
                mMonth = month
                mDay = dayOfMonth
