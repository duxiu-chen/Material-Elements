...
import com.zhugeng.materialdesign.adapter.GridBasicAdapter
import kotlinx.android.synthetic.main.activity_grid_basic.*
import kotlinx.android.synthetic.main.title_bar.*

class GridBasicActivity: AppCompatActivity() {
    ...
    private lateinit var adapter: GridBasicAdapter
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = GridBasicAdapter(data, this)
