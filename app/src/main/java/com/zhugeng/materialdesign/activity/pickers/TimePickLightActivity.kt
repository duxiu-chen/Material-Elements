...
class TimePickLightActivity : AppCompatActivity(){
    ...
    private fun initView() {
        ...
        btn_get_date.setOnClickListener {
            TimePickerDialog(this, R.style.LightDatePickerDialogTheme ,TimePickerDialog.OnTimeSetListener { view, hourOfDay, minute ->
