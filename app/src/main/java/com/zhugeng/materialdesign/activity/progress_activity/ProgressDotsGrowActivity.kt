...
import kotlinx.android.synthetic.main.activity_progress_dots_grow.*
import java.util.*

class ProgressDotsGrowActivity: AppCompatActivity() {
    ...
    fun startAnim(){
        ...
        handler.postDelayed({
            ...
            anim.addUpdateListener {
                ...
                if (x == 0f){
                    recyclerView.layoutAnimation = AnimationUtils.loadLayoutAnimation(this@ProgressDotsGrowActivity, R.anim.layout_anim_fade_in_list_item)
                    recyclerView.layoutManager = LinearLayoutManager(this@ProgressDotsGrowActivity)
                    initData()
