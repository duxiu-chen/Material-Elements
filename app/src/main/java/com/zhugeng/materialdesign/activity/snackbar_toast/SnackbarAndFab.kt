...
import kotlinx.android.synthetic.main.activity_snackbar_fab.*
import kotlinx.android.synthetic.main.title_bar.*
import java.util.*

class SnackbarAndFab: AppCompatActivity() {
    ...
    private fun initListener() {
        fab_add.setOnClickListener {
            Snackbar.make(coordinator, "FAB Add clicked", Snackbar.LENGTH_SHORT).show()
        }
    }

    private fun initView() {
        toolbar.title = "Snackbar Fab"
