...
class SwipeAdapter (private var context: Context, private var datas: LinkedList<BottomSheetBasicBean>) :
        RecyclerView.Adapter<SwipeAdapter.Holder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        return Holder(LayoutInflater.from(context).inflate(R.layout.item_list_swipe, parent, false))
    }
